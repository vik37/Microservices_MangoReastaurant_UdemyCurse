...
{
    public class RabbitMQPaymentCounsumer : BackgroundService
    {
        ...
        public RabbitMQPaymentCounsumer(IRabbitMQPaymentMessageSender rabbitMQPaymentMessageSender,
                                        IProcessPayment processPayment)
        {
            ...
            _channel.QueueDeclare(queue: "orderpaymentproccesstopic", false, false, false, arguments: null);
        }
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _channel.BasicConsume("orderpaymentproccesstopic", false, consumer);
