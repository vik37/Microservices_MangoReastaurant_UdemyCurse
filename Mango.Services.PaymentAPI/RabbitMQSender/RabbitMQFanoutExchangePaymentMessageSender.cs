...
{
    public class RabbitMQFanoutExchangePaymentMessageSender : IRabbitMQPaymentMessageSender
    {
        ...
        public RabbitMQFanoutExchangePaymentMessageSender()
        {
            _hostname = "localhost";
            _username = "guest";
            _password = "guest";
        ...
        {
            // FANOUT - Type of RabbitMQ message exchange
            if (ConnectionExist())
            {
